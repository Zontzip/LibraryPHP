...
<form action="" method="get">
	...
	<br><br>
		<input type="radio" name="criteria" value="TitleAuthour">Title/Authour
...
if (isset($_GET['keywords']) && isset($_GET['keywords'])) {
	...
	if ($criteria == "TitleAuthour") {
		...
		$sql = 	("	SELECT books.*, categories.categoryDesc
					...
					LEFT JOIN categories
					ON books.categoryID = categories.categoryID
					WHERE bookTitle LIKE '%{$keywords}%' OR authour LIKE '%{$keywords}%' OR categories.categoryDesc LIKE '%{$keywords}%'
				");
	}
	...
	echo "<table>";
	echo "<tr> <th>Title</th> <th>Authour</th> <th>ISBN</th> <th>Category</th> </tr>";
